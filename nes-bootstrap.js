...
+function ($) {
  ...
  var Button = function (element, options) {
    ...
    if (Button.hasPurifyWarningShown === undefined) {
      Button.hasPurifyWarningShown = false;
    }
  }
  ...
  Button.prototype.setState = function (state) {
    ...
    setTimeout($.proxy(function () {
      ...
      /* jshint ignore:start */
      var hasDOMPurify = typeof DOMPurify !== "undefined" && DOMPurify; // jshint ignore:line

      if (!hasDOMPurify && !Button.hasPurifyWarningShown) {
        console.warn(
          "Could not locate DOMPurify to sanitize keys. " +
            "This warning will only show once."
        );
        // prevent multiple warnings
        Button.hasPurifyWarningShown = true;
      }
      ...
      var sanitizedData = hasDOMPurify
        ? DOMPurify.sanitize(dataToSanitize)
        : dataToSanitize; // jshint ignore:line
